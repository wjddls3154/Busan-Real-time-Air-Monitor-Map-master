...
class ViewController: UIViewController, MKMapViewDelegate, XMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        timer = Timer.scheduledTimer(timeInterval: 60, target: self, selector: #selector(myParse), userInfo: nil, repeats: true)
        ...
        if let url = URL(string: strURL) {
            ...
            if let parser = XMLParser(contentsOf: url) {
                ...
                if (parser.parse()) {
                    ...
                    dayTimePeriodFormat.dateFormat = "YYYY/MM/dd HH:mm"
